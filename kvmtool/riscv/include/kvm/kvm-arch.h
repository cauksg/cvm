...
#define CVM_VM_TYPE		0x20000217
#define CVM_RMEM_ADDR		0x82c00000ULL
#define CVM_RMEM_SIZE		SZ_2M
#define CVM_VIRTIO_RMEM_ADDR	CVM_RMEM_ADDR
#define CVM_VIRTIO_RMEM_SIZE	SZ_1M
#define CVM_VFIO_RMEM_ADDR	(CVM_RMEM_ADDR + CVM_VIRTIO_RMEM_SIZE)
#define CVM_VFIO_RMEM_SIZE	(CVM_RMEM_SIZE - CVM_VIRTIO_RMEM_SIZE)
...
extern bool riscv_cove_io_restricted_dma;
