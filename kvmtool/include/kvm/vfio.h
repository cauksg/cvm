...
struct vfio_device {
	...
	u64				cove_io_tdi_id;
	u64				cove_io_mmio_gpa;
	u64				cove_io_mmio_size;
	u64				cove_io_irq_id;
	u64				cove_io_irq_num;
	int				cove_io_irq_msi_active;
	u64				cove_io_device_id;
	u32				iommufd_ioas_id;
	bool				iommufd_ioas_valid;
	bool				cove_io_dma_mapped;
};
...
struct vfio_device_params {
	...
	u64				cove_io_device_id;
	u16				cove_io_pci_segment;
	u16				cove_io_pci_requester_id;
};
